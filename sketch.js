...
var backgroundIMG, background1IMG, background2IMG, background3IMG, background4IMG, background5IMG
...
function preload()
{
   ...
   background1IMG = loadImage("background1.gif")
   background2IMG = loadImage("background2.gif")
   background3IMG = loadImage("background3.gif")
   background4IMG = loadImage("background4.gif")
   background5IMG = loadImage("background5.gif")
}
...
function setup() {
  ...
  block16 = new Blue_Block(1000, 370, 50, 50)

  block17 = new Blue_Block(980, 390, 50, 50)
  block18 = new Blue_Block(1010, 390, 50, 50)

  block19 = new Blue_Block(960, 410, 50, 50)
  block20 = new Blue_Block(1000, 410, 50, 50)
  block21 = new Blue_Block(1030, 410, 50, 50)

  block22 = new Blue_Block(940, 440, 50, 50)
  block23 = new Blue_Block(970, 440, 50, 50)
  block24 = new Blue_Block(1020, 440, 50, 50)
  block25 = new Blue_Block(1060, 440, 50, 50)
  ...
  block31 = new Green_Block(1500, 370, 50, 50)

  block32 = new Green_Block(1480, 390, 50, 50)
  block33 = new Green_Block(1510, 390, 50, 50)

  block34 = new Green_Block(1460, 410, 50, 50)
  block35 = new Green_Block(1500, 410, 50, 50)
  block36 = new Green_Block(1530, 410, 50, 50)
  ...
  block46 = new Red_Block(2000, 370, 50, 50)

  block47 = new Red_Block(1980, 390, 50, 50)
  block48 = new Red_Block(2010, 390, 50, 50)

  block49 = new Red_Block(1960, 410, 50, 50)
  block50 = new Red_Block(2000, 410, 50, 50)
  block51 = new Red_Block(2030, 410, 50, 50)

  block52 = new Red_Block(1940, 440, 50, 50)
  block53 = new Red_Block(1970, 440, 50, 50)
  block54 = new Red_Block(2020, 440, 50, 50)
  block55 = new Red_Block(2060, 440, 50, 50)
...
function draw() {
 ...
 if(frameCount % 100 === 0){
  colour = Math.round(random(1, 6)) 
 }

  switch(colour){
     case 1:  background(backgroundIMG);
              break;
     case 2:  background(background1IMG);
              break;
     case 3:  background(background2IMG);
              break;
     case 4:  background(background3IMG);
              break;
     case 5:  background(background4IMG);
              break;
     case 6:  background(background5IMG);
              break;                                             
  }
